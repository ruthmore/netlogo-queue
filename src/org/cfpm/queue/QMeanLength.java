 ...
 *
 */
public class QMeanLength extends DefaultReporter {

	/** The mean-length primitive expects a queue as input and returns a number (the average length of the given queue).
	 * 
	 */
	...
	/** Returns the average length of the specified queue. The first argument 
	 * {@link args[0]} has to be a queue.
	 * Generates an error if the argument is invalid.
	 * 
	 * @param args the arguments to this call of mean-length
	...
	public Object report(Argument[] args, Context context) throws ExtensionException, LogoException {
		...
		return Double.valueOf(((Queue)arg0).getMeanSize());
	}
